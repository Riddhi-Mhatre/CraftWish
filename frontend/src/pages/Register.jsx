...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-bl from-[#FAF8F5] to-orange-50 p-4">
      <div className="bg-white rounded-3xl shadow-[0_20px_50px_rgba(139,94,60,0.15)] w-full max-w-4xl overflow-hidden flex flex-col md:flex-row-reverse animate-fade-in border border-orange-100/50">
        ...
        <div className="w-full md:w-1/2 relative min-h-[250px] md:min-h-[500px]">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent z-20 flex flex-col justify-end p-10">
            <h2 className="text-3xl font-heading text-white font-bold mb-2">Join CraftWish</h2>
            <p className="text-gray-200">Start crafting unforgettable memories with personalized gifts today.</p>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-10 md:p-14 flex flex-col justify-center">
          ...
          <div className="mt-8 text-center border-t border-gray-100 pt-6">
            <p className="text-sm text-gray-600">
              Already have an account? <Link to="/login" className="text-[#8B5E3C] font-bold hover:underline transition-all">Log in</Link>
            </p>
          </div>
        </div>
